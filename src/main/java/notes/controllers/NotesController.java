...
public class NotesController {
	...
	@GetMapping("/{id}/edit-put")
	public String openPutForm(@PathVariable Long id, Model model) {
		Note note = this.restClientNotes.getNoteById(id);
		...
		return "note-edit-put";
	}
	
	@PutMapping
	public String putNote(@Valid Note note, BindingResult errors) {
		if (errors.hasErrors()) 
			return "note-edit-put";
		...
		this.restClientNotes.putNote(map, note.getId());
		
		return "redirect:/notes-list";
	}
	
	@GetMapping("/{id}/edit-patch")
	...
	public String patchNote(@Valid Note note, BindingResult errors) {
		...
		this.restClientNotes.patchNote(map, note.getId());
